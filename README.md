...
- 이름: 김 태호 </br>
- 생년월일: 1992.10.05 (만 33세) </br>
- 최종학위: 국민대학교 식품영양학 </br>
- 개발경력: 2023.06 ~ (2년 11개월) </br>
- 자격증: 정보처리기사 / 네트워크관리사2급 / e-test professional </br>
- 교육활동 </br>
  - 이젠컴퓨터아카데미 Java Full Stack (22.12.30~23.05.25, 800시간) </br>
  - 멘티 활동 (23.11.01~24.05.31)</br>
    내용: 웹개발 프로그램에 필요한 서적 회독 및 소규모 프로젝트 진행</br>
    서적: 객체지향 사고프로세스, 컴퓨터 구조 및 운영체제, 객체지향의 사실과 오해, 좋은 코드/나쁜 코드, 도메인 주도 개발 시작하기</br>
...
> - 시험 결과값, 시험일지 엑셀 파일에 자동 매핑 기능 구현</br>
>
...
>
> **담당업무:** </br>
> - 대용량 Excel(Apache POI) Import/Export 고도화 및 데이터 무결성 검증 로직 구현 (시험 데이터 일괄 등록)</br>
> - CubeOne 암호화 API 전사 적용 및 보안 인증 (개인정보/민감 데이터 column-level 암호화) </br>
> - FindBugs 정적 분석 도구를 활용한 코드 품질 관리 </br>
> - Spring Boot 기반 RESTful CRUD API 설계 및 트랜잭션 관리 </br>
>
...
>
> **담당업무:** </br>
> - 사용자 권한 기능 추가 (유저별 권한 도입 / 권한에 따른 메뉴 접근) </br>
> - Spring Boot 기반 RESTful CRUD API 설계 및 트랜잭션 관리 </br>
>
